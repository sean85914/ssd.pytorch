...
class strawberryAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(STRAWBERRY_CLASSES, range(len(STRAWBERRY_CLASSES))))
...
class StrawberryDetection(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=[('train')],
                 transform=None, target_transform=strawberryAnnotationTransform(),
